  ...
  return (
    <div className="w-full max-w-md bg-ink-900/60 backdrop-blur-xl border border-ink-700/50 rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] p-8 sm:p-10 flex flex-col my-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-neutral-400 mt-2">Enter your credentials to access your account</p>
      </div>
      ...
      <div className="mt-5 text-center">
        <Link href="/reset-password" className="text-sm font-medium text-neutral-400 hover:text-white transition-colors">
